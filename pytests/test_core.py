"""
Comprehensive pytest tests for nsct_torch/core.py

Tests numerical accuracy, precision, shape consistency, and one-to-one consistency
between NumPy (nsct_python/core.py) and PyTorch (nsct_torch/core.py) implementations.
...
from nsct_torch.filters import dfilters as dfilters_torch, atrousfilters as atrousfilters_torch
...
class TestNsdfbdecConsistency:
    ...
    def test_nsdfbdec_levels(self, n_levels):
        ...
        from nsct_torch.filters import modulate2 as modulate2_torch, parafilters as parafilters_torch
...
class TestEdgeCases:
    ...
    def test_nsdfbrec_invalid_subband_count(self):
        ...
        from nsct_torch.filters import modulate2, parafilters
        k1 = modulate2(h1, 'c')
        k2 = modulate2(h2, 'c')
