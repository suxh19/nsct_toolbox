/*
 * atrousc_cuda.cpp - PyTorch C++ extension interface for CUDA-accelerated atrousc
 * 
...
// Declare CUDA kernel launcher (defined in atrousc_cuda_launcher.cu)
void atrousc_cuda_launcher(
 ...
 */
torch::Tensor atrousc_torch_cuda(
    ...
    TORCH_CHECK(x_input.dim() == 2, "Input tensor x must be 2D");
    ...
    // ===== Launch CUDA Kernel =====
    atrousc_cuda_launcher(x, h, out, M0, M3);
