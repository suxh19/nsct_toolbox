"""
zconv2_cuda - CUDA-accelerated 2D convolution with upsampled filter
...
try:
    from .zconv2_cuda import zconv2 as zconv2_cuda
    CUDA_AVAILABLE = True
...
__all__ = ['zconv2_cuda', 'is_available', 'get_import_error', 'CUDA_AVAILABLE']
