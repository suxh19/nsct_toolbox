"""
setup.py for building the zconv2_cpp C++ extension module

This script compiles the high-performance C++ implementation of 
2D convolution with upsampled filter and creates a Python extension module.
...
setup(
    ...
    description='High-performance C++ implementation of 2D convolution with upsampled filter',
