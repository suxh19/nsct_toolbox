"""
atrousc_cuda - CUDA-accelerated à trous convolution
...
try:
    from .atrousc_cuda import atrousc as atrousc_cuda
    CUDA_AVAILABLE = True
    _import_error = None
...
__all__ = ['atrousc_cuda', 'is_available', 'get_import_error', 'CUDA_AVAILABLE']
