"""
setup.py for building the atrousc_cuda CUDA extension module

This script compiles the CUDA implementation of à trous convolution
and creates a PyTorch C++ extension module.
...
print(f"\n{'='*70}")
print(f"Building atrousc_cuda extension")
print(f"{'='*70}")
...
ext_modules = [
    CUDAExtension(
        ...
        sources=[
            'atrousc_cuda.cpp',
            'atrousc_cuda_launcher.cu',
            'atrousc_cuda_kernel.cu',
        ],
        extra_compile_args={
            'cxx': cxx_flags,
            'nvcc': nvcc_flags,
...
setup(
    ...
    description='CUDA-accelerated à trous convolution for NSCT',
    long_description='High-performance GPU implementation of à trous convolution used in the Nonsubsampled Contourlet Transform (NSCT).',
