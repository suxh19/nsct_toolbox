...
- zconv2: 2D convolution with upsampled filter (periodic boundary)
- atrousc: Atrous convolution with symmetric extension
...
from nsct.filters import efilter2, dfilters, modulate2, parafilters, atrousfilters
from nsct.utils import extend2, symext, upsample2df
from nsct.zconv2 import zconv2
from nsct.atrousc import atrousc
...
if __name__ == '__main__':
    from nsct.filters import dfilters
